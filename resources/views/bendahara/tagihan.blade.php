            ...
            <div>
                ...
                <div class="px-4 mt-6">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="{{ route('bendahara.tagihan') }}" class="sidebar-item sidebar-active">
            ...
            <div class="p-7 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('bendahara.tagihan.create') }}"
                        class="h-12 px-5 rounded-2xl bg-gradient-to-r from-teal-400 to-emerald-500 text-slate-900 font-semibold flex items-center gap-2 btn-primary">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="w-full">
                            ...
                            <thead class="bg-slate-50">
                                <tr>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-slate-500">Nama Tagihan</th>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-slate-500">Periode</th>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-slate-500">Nominal</th>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-slate-500">Deadline</th>
                                    <th class="text-center py-4 px-6 text-sm font-semibold text-slate-500">Aksi</th>
                                </tr>
                            </thead>

                            <tbody class="bg-white">
                                {{-- PROSES LOOPING DATA ASLI DARI DATABASE --}}
                                ...
                                <tr class="table-row border-b border-slate-100">
                                    ...
                                    <td class="py-5 px-6">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            {{-- Form hapus data --}}
                                            <form action="{{ route('bendahara.tagihan.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus tagihan ini?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="py-8 text-center text-sm text-slate-400 font-medium">
                                        Belum ada data tagihan yang dibuat.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
