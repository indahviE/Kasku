...
<head>
    ...
    <title>Edit Tagihan - KASKU</title>
        ...
        <div class="p-8">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="form-wrapper p-8">
                 ...
                 <form action="{{ route('bendahara.tagihan.update', $tagihan->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="date"
                                       name="periode"
                                       class="input"
                                       value="{{ \Carbon\Carbon::parse($tagihan->periode)->format('Y-m-d') }}"
                                       required>
                            ...
                            <div>
                                ...
                                <input type="date"
                                       name="batas_bayar"
                                       class="input"
                                       value="{{ \Carbon\Carbon::parse($tagihan->batas_bayar)->format('Y-m-d') }}"
                                       required>
                        ...
                        <div class="flex items-center justify-between pt-3">
                            ...
                            <button type="submit"
                                ...
                                <iconify-icon icon="solar:pen-bold" class="text-[20px]"></iconify-icon>
