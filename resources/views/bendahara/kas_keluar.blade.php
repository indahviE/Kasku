...
<head>
    ...
    <style>
        ...
        /* SIDEBAR SAMA PERSIS KAYA KAS MASUK */
        .sidebar {
            background: #0a0f1d;
            overflow: hidden;
        }
...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="ml-[250px] flex-1 overflow-y-auto h-screen">
        ...
        <div class="p-8 max-w-7xl mx-auto fade-in space-y-8">
            ...
            <div>
                <h1 class="text-[32px] font-bold text-slate-900 tracking-tight">
                    Kas Keluar
                </h1>

                <p class="text-slate-500 text-sm mt-2">
                    Daftar semua alokasi pembiayaan operasional beserta monitoring sisa anggaran bulanan.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="stat-card rounded-2xl p-6 shadow-sm bg-gradient-to-br from-slate-900 to-slate-800 text-white border-0">
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="px-2 py-0.5 rounded bg-amber-500/20 text-amber-400 text-[11px] font-bold tracking-wide uppercase">
                            71% Terpakai
                        </span>
                    </div>
                    ...
                    <h3 class="text-[22px] font-bold text-white">
                        Rp 1.420.000
                        <span class="text-xs text-slate-400 font-normal">/ Rp 2.000.000</span>
                    </h3>
                    ...
                    <p class="text-[11px] text-slate-400 mt-3">
                        Sisa kuota aman anggaran bulan ini:
                        <span class="text-slate-200 font-semibold">Rp 580.000</span>
                    </p>
                ...
                <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div>
                        <h2 class="text-[18px] font-bold text-slate-900">
                            Riwayat Pengeluaran Real-time
                        </h2>

                        <p class="text-sm text-slate-400 mt-1">
                            Daftar transparansi penggunaan dana kas keluar fisik dan digital.
                        </p>
                    </div>
                            ...
                            <tr class="table-hover border-t border-slate-100 transition">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center justify-center">
                                        <button class="w-9 h-9 rounded-xl bg-red-50 hover:bg-red-100 text-red-500 flex items-center justify-center transition">
