...
<title>KASKU Dashboard - Premium</title>
...
.card {
    ...
    box-shadow: 0 4px 6px rgba(0, 0, 0, 0.03), 0 10px 30px rgba(15, 23, 42, 0.04);
}
...
.stat-card:hover {
    ...
    box-shadow: 0 20px 45px rgba(45, 212, 191, 0.12), 0 10px 30px rgba(15, 23, 42, 0.08);
}
...
.trending-up {
    animation: trendingUp 0.8s ease-out;
}
...
<div class="flex h-screen overflow-hidden">
    ...
    <!-- MAIN -->
    <main class="ml-[260px] flex-1 overflow-y-auto">
