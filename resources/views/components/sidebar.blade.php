<aside class="w-[250px] bg-white px-7 py-8 shadow-sm flex flex-col justify-between">
    ...
    <div>
        ...
        <nav class="mt-16 space-y-3 text-[15px] font-semibold">
            ...
            <!-- DASHBOARD -->
            <a href="#"
               class="flex items-center gap-3 bg-[#E8F1F3] text-[#0F5D73] px-4 py-3 rounded-xl transition">
            ...
            <!-- KAS MASUK -->
            <a href="#"
               class="flex items-center gap-3 text-gray-500 hover:bg-[#F4F7F8] hover:text-[#0F5D73] px-4 py-3 rounded-xl transition">
    ...
    <div class="space-y-3">
        ...
        <!-- LOGOUT -->
        <a href="#"
           class="flex items-center gap-3 text-red-500 hover:bg-red-50 px-4 py-3 rounded-xl transition font-semibold text-[15px]">
